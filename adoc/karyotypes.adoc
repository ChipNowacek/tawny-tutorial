...
one report I have heard suggests that protege users spend up to 50% of their
...
[NOTE]
====
Another option, written by Samuel Croset is Brain. Much lighter weight than
...
of Java. Any changes require, recompile, and restart: it is slow.
====
endif::backend-slidy[]
...
convenient to use. It can be used cleanly in batch. In general, very nice.
